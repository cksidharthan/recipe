...
INSERT INTO RECIPE (NAME, DESCRIPTION, INGREDIENTS, DIRECTIONS, SERVINGS, PREP_TIME)
...
VALUES ('Chicken Cordon Bleu',
        ...
        4, 45);
INSERT INTO RECIPE (NAME, DESCRIPTION, INGREDIENTS, DIRECTIONS, SERVINGS, PREP_TIME)
VALUES ('Chicken Marsala',
        'Chicken Marsala is a classic Italian-American dish that is easy to make at home. It is a simple dish of chicken sauteed in a Marsala wine sauce.',
        '1/2 cup all-purpose flour, 2 eggs, beaten, 1 cup Italian-style bread crumbs, 1/2 teaspoon salt, 1/4 teaspoon ground black pepper, 4 skinless, boneless chicken breast halves - pounded 1/4 inch thick, 1/2 cup butter, 1/2 cup chopped onion, 1/2 cup sliced mushrooms, 1/2 cup Marsala wine, 1/2 cup chicken broth, 1/4 cup heavy cream',
        'Preheat oven to 350 degrees F (175 degrees C). Place flour in a shallow dish. Beat eggs in a separate shallow dish. Mix bread crumbs, salt, and pepper together in a third shallow dish. Dip chicken into flour, then into egg, and finally into bread crumb mixture to coat. Place chicken in a 9x13 inch baking dish. Bake in the preheated oven for 30 minutes. Meanwhile, melt butter in a saucepan over medium heat. Stir in onion and mushrooms, and cook until tender. Stir in Marsala wine, chicken broth, and cream. Bring to a boil, and cook until thickened, about 5 minutes. Serve sauce over chicken.',
        4, 45);
INSERT INTO RECIPE (NAME, DESCRIPTION, INGREDIENTS, DIRECTIONS, SERVINGS, PREP_TIME)
VALUES ('Chicken Piccata',
        'Chicken Piccata is a classic Italian-American dish that is easy to make at home. It is a simple dish of chicken sauteed in a lemon butter sauce.',
        '1/2 cup all-purpose flour, 2 eggs, beaten, 1 cup Italian-style bread crumbs, 1/2 teaspoon salt, 1/4 teaspoon ground black pepper, 4 skinless, boneless chicken breast halves - pounded 1/4 inch thick, 1/2 cup butter, 1/2 cup lemon juice, 1/4 cup chicken broth, 1/4 cup white wine',
        'Preheat oven to 350 degrees F (175 degrees C). Place flour in a shallow dish. Beat eggs in a separate shallow dish. Mix bread crumbs, salt, and pepper together in a third shallow dish. Dip chicken into flour, then into egg, and finally into bread crumb mixture to coat. Place chicken in a 9x13 inch baking dish. Bake in the preheated oven for 30 minutes. Meanwhile, melt butter in a saucepan over medium heat. Stir in lemon juice, chicken broth, and wine. Bring to a boil, and cook until thickened, about 5 minutes. Serve sauce over chicken.',
        4, 45);
